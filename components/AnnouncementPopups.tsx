...
export function AnnouncementPopups({
  ...
  return (
    <div className="fixed inset-0 z-[95] flex items-center justify-center px-3 py-4 sm:p-8">
      ...
      />
      <div
        className={`pointer-events-auto relative flex h-[92dvh] max-h-[900px] w-full max-w-[500px] transition-[max-width] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] sm:max-w-[632px] ${
          desktopDetail
            ? "lg:max-w-[1192px]"
            : pricingFallback
              ? "lg:max-w-[648px]"
