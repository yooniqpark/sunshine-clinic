export const clinic = {
  ...
  hours: [
    ...
    { day: "토요일", time: "10:00 – 15:00 (점심시간 없음)" },
    { day: "점심시간", time: "13:00 – 14:00" },
    { day: "일요일·공휴일", time: "휴진" },
  ],
  address: "서울특별시 강남구 테헤란로 123, 4층",
  addressSub: "2호선 강남역 4번 출구 도보 3분 · 건물 내 주차 가능",
  social: {
...
export const chatbot = {
  ...
  fallback:
    "정확한 답변이 어려운 질문이네요. 자세한 내용은 전화(02-1234-5678)나 카카오톡 상담으로 친절하게 도와드릴게요!",
...
export const faq: FaqItem[] = [
  ...
  {
    q: "주차할 수 있나요?",
    a: "건물 내 주차가 가능합니다. 2호선 강남역 4번 출구에서 도보 3분 거리이며, 주차 등록은 진료 후 데스크에서 도와드립니다.",
    keywords: ["주차", "차", "parking", "발렛"],
  },
  {
    q: "예약 없이 방문해도 되나요?",
    a: "예약 없이 방문하셔도 진료 가능하지만, 대기 시간을 줄이시려면 예약을 권장드립니다. 전화(02-1234-5678) 또는 카카오톡 채널로 예약하실 수 있어요.",
