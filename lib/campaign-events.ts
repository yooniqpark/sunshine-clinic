...
const FIRST_VISIT: Campaign = {
  ...
  categories: [
    ...
    },
    {
      ...
      rows: [
        { name: "뉴리미스 · 입술 1cc", event: "15만원" },
        { name: "뉴리미스 · 애교 1cc", event: "15만원" },
        { name: "뉴리미스 · 턱 1cc", event: "15만원" },
        { name: "쥬비덤 · 입술 1cc", event: "25만원" },
        { name: "쥬비덤 · 애교 1cc", event: "25만원" },
        { name: "쥬비덤 · 턱 1cc", event: "25만원" },
    ...
    },
    {
      ...
      rows: [
        { name: "STEP 2 · 슈링크 300샷", desc: "슬림윤곽주사 10cc 포함", event: "15만원" },
        { name: "STEP 2 · 인모드 miniFX", desc: "슬림윤곽주사 10cc 포함", event: "25만원" },
        { name: "STEP 3 · 인모드 miniFX + 슈링크 300샷", desc: "슬림윤곽주사 10cc 포함", event: "35만원" },
      ],
    },
    {
      slug: "collagen",
      ...
      rows: [{ name: "쥬베룩 볼륨 · 1병", event: "40만원" }],
    },
  ],
};
