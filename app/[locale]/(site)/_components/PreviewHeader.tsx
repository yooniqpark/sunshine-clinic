      ...
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 lg:h-28 lg:px-8">
        ...
        >
          ...
          <div className="flex flex-col leading-none">
            ...
            <span
              className={`-mt-1 pl-[2px] font-serif text-[11px] font-normal uppercase tracking-[0.24em] transition lg:-mt-1.5 lg:text-[13px] ${subColor}`}
            >
              {tBrand("label")}
            </span>
          </div>
        ...
        <div className="flex items-center gap-3 lg:hidden">
          <LanguageSwitcher variant="compact" tone={solid ? "light" : "dark"} />
          <button
            type="button"
            onClick={() => setOpen((v) => !v)}
